...
const Create = () => {
    ...
    const handleAdd = async () => {
         axios.post('http://localhost:3001/add',{task:task}).then(location.reload())
    }
  return (
    <div  className='md:w-[760px]  bg-blue-700 h-[52px] absolute  flex items-center justify-center -top-[20px] cursor-pointer' >
    <input type="text" name="" id="" onChange={(e)=>setTasks(e.target.value)} className='w-full px-4 py-2 bg-gray-700 text-white rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500'/>
      <span onClick={handleAdd}>
        <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
          <g clipPath="url(#clip0_1040_89)">
            ...
            <path d="M11.707 7.38126H8.4954V4.16965H7.41397V7.38126H4.19873V8.46268H7.41397V11.6743H8.4954V8.46268H11.707V7.38126Z" fill="#F2F2F2" />
          </g>
          <defs>
